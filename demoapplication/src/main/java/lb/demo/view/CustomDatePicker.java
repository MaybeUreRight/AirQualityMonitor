...
public class CustomDatePicker {
    ...
    private TextView month_pv_unit, day_pv_unit;
    ...
    private void initView() {
        ...
        month_pv_unit = datePickerDialog.findViewById(R.id.month_pv_unit);
        day_pv = datePickerDialog.findViewById(R.id.day_pv);
        day_pv_unit = datePickerDialog.findViewById(R.id.day_pv_unit);
    ...
    public void showSpecialDay(boolean show) {
        if (canAccess) {
            if (show) {
                disScrollUnit();
                day_pv.setVisibility(View.VISIBLE);
                day_pv_unit.setVisibility(View.VISIBLE);
            } else {
                disScrollUnit(SCROLL_TYPE.HOUR, SCROLL_TYPE.MINUTE);
                day_pv.setVisibility(View.GONE);
                day_pv_unit.setVisibility(View.GONE);
            }
        }
    }

    public void showSpecialMonth(boolean show) {
        if (canAccess) {
            if (show) {
                disScrollUnit();
                month_pv.setVisibility(View.VISIBLE);
                month_pv_unit.setVisibility(View.VISIBLE);
            } else {
                disScrollUnit(SCROLL_TYPE.HOUR, SCROLL_TYPE.MINUTE);
                month_pv.setVisibility(View.GONE);
                month_pv_unit.setVisibility(View.GONE);
            }
        }
    }
