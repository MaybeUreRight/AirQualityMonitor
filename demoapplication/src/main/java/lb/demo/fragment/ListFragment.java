...
import lb.demo.view.MyListView;
        ...
        switch (view.getId()) {
            ...
            case R.id.list_item_3:
                ...
                if (currentPosition == 3) {
                    ...
                    if (tempList3 != null) {
                        ...
                        String startDate = ListFragment.this.sdf.format(getLongFromString(lastSelectedWeek + SUFFIX) - INTERVAL);
            ...
            case R.id.list_item_5:
                ...
                if (currentPosition == 5) {
                    ...
                    //时间只显示年份
                    customDatePicker1.showSpecialDay(false);
                    customDatePicker1.showSpecialMonth(false);
//                    customDatePicker1.showSpecificTime(false);
                    list_update_time.setText(PRE + lastSelectedYear);
            ...
            public void handle(String time) { // 回调接口，获得选中的时间
                ...
                switch (currentPosition) {
                    ...
                    case 3:
                        ...
                        list_update_time.setText(PRE + lastSelectedWeek);
                        String startDate = ListFragment.this.sdf.format(getLongFromString(lastSelectedWeek + SUFFIX) - INTERVAL) + SUFFIX;
                        LogUtils.lb("startDate = " + startDate);
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        lastSelectedYear = time.split(" ")[0].substring(0, 4);
                        list_update_time.setText(PRE + lastSelectedYear);
